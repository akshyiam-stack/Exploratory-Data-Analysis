...
├── README.md
└── .gitignore
Note: Dataset is not included in this repository due to file size. Download it from Kaggle and place it in a data/ folder.
...
Column selection — Reduced from 65 → 22 relevant columns
Null value handling
...
Duplicate removal — Dropped 636 duplicate rows
Team name standardisation — Fixed historical name changes across all 4 team columns:
Delhi Daredevils → Delhi Capitals
Kings XI Punjab → Punjab Kings
Deccan Chargers → Sunrisers Hyderabad
Royal Challengers Bangalore → Royal Challengers Bengaluru
Rising Pune Supergiants → Rising Pune Supergiant
Season format fix — Converted 2007/08 → 2008, 2009/10 → 2010 etc.
Season splitting — Separated merged 2020/21 data back into correct years (2020 UAE season + 2021)
Incomplete data removal — Dropped 24 matches from early IPL 2026 that were incorrectly included
...
Mumbai Indians are the most dominant IPL franchise with 151 wins across 17 seasons
Toss strategy matters — teams that choose to field after winning the toss win 8% more often than those who bat
Virat Kohli is in a class of his own — 8,671 runs, over 1,600 ahead of the next player
Spin dominates — 8 of the top 15 wicket takers are spinners, reflecting Indian pitch conditions
Death overs are decisive — averaging 9.52 runs/over, teams with strong death bowlers have a massive advantage
RCB 2025 was their best-ever campaign — 10 league wins, dominant Qualifier 1, and a nail-biting 6-run final win
📚 Skills Demonstrated
...
👤 Author
Akshay — Electronics and Communication Engineering Aspiring Data Analyst | Data Science Enthusiast
